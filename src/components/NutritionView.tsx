...
export function NutritionView({ onBack }: NutritionViewProps) {
  ...
  return (
    <div className="pb-20">
      {/* Header */}
      <div className="bg-gradient-to-br from-purple-500 to-pink-600 text-white p-6 rounded-b-3xl shadow-lg">
        <Button
          onClick={onBack}
          variant="ghost"
          size="sm"
        ...
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-2xl mb-2">Nutrición</h1>
      ...
      <div className="px-4 pt-6 space-y-6">
        ...
        <Card className="p-6 bg-white border-0 shadow-md">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h2 className="text-lg text-gray-900">Estadísticas Semanales</h2>
          </div>
        ...
        <div>
          <div className="flex items-center justify-between mb-3">
            <h2 className="text-lg text-gray-900">Milo - Gato Siamés</h2>
            <Badge className="bg-emerald-100 text-emerald-700 hover:bg-emerald-100">
              Activo
            </Badge>
          </div>
